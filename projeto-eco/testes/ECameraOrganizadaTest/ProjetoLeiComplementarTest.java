...
class ProjetoLeiComplementarTest {
    ...
    void criaPLPCodigoVazio() {
        assertThrows(IllegalArgumentException.class, () -> new PLP("", "112345678-6",
                2016, "Ementa PLP", "saude", "http://example.com/semana_saude", "153"));
    }

    @Test
    void criaPLPCodigoNulo() {
        assertThrows(NullPointerException.class, () -> new PLP(null, "112345678-6",
                2016, "Ementa PLP", "saude", "http://example.com/semana_saude", "153"));
    }

    @Test
    void criaPLPDniVazio() {
        assertThrows(IllegalArgumentException.class, () -> new PLP("PLP 1/2016", "",
                2016, "Ementa PLP", "saude", "http://example.com/semana_saude", "153"));
    }

    @Test
    void criaPLPDniNulo() {
        assertThrows(NullPointerException.class, () -> new PLP("PLP 1/2016", null,
                2016, "Ementa PLP", "saude", "http://example.com/semana_saude", "153"));
    }
    ...
    void criaPLPEmentaNula() {
        assertThrows(NullPointerException.class, () -> new PLP("PLP 1/2016",
