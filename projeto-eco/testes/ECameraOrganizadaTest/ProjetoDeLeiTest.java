...
class ProjetoDeLeiTest {
    ...
    void criaPLConclusivaCodigoVazio() {
        assertThrows(IllegalArgumentException.class, () -> new ProjetoDeLei("", "112345678-6",
                2016, "Ementa PL conc", "saude", "http://example.com/semana_saude", true));
    }

    @Test
    void criaPLConclusivaCodigoNulo() {
        assertThrows(NullPointerException.class, () -> new ProjetoDeLei(null, "112345678-6",
                2016, "Ementa PL conc", "saude", "http://example.com/semana_saude", true));
    }

    @Test
    void criaPLConclusivaDniVazio() {
        assertThrows(IllegalArgumentException.class, () -> new ProjetoDeLei("PL 1/2016", "",
                2016, "Ementa PL conc", "saude", "http://example.com/semana_saude", true));
    }

    @Test
    void criaPLConclusivaDniNulo() {
        assertThrows(NullPointerException.class, () -> new ProjetoDeLei("PL 1/2016", null,
                2016, "Ementa PL conc", "saude", "http://example.com/semana_saude", true));
    }

    @Test
    void criaPLConclusivaEmentaVazia() {
        assertThrows(IllegalArgumentException.class, () -> new ProjetoDeLei("PL 1/2016", "112345678-6",
                2016, "", "saude", "http://example.com/semana_saude", true));
    }

    @Test
    void criaPLConclusivaEmentaNula() {
        assertThrows(NullPointerException.class, () -> new ProjetoDeLei("PL 1/2016", "112345678-6",
    ...
    void criaPLConclusivaDniInvalidoComLetra() {
        assertThrows(IllegalArgumentException.class, () -> new ProjetoDeLei("PL 1/2016", "A112345678-6",
                2016, "Ementa PL conc", "saude", "http://example.com/semana_saude", true));
    }
    ...
    void criaPLConclusivaDadosValidos() {
        this.projetoDeLei = new ProjetoDeLei("PL 1/2016", "112345678-6", 2016, "Ementa PL conc",
                "saude", "http://example.com/semana_saude", true);
    }

    @Test
    void criaPLNaoConclusivaDadosValidos() {
        this.projetoDeLei = new ProjetoDeLei("PL 1/2016", "112345678-6", 2016, "Ementa PLnconc",
