...
class ProjetoEmendaConstitucionalTest {
    ...
    void criaPECCodigoVazio() {
        assertThrows(IllegalArgumentException.class, () -> new PEC("", "112345678-6",
                2016, "Ementa PEC", "saude", "http://example.com/semana_saude", "153"));
    }

    @Test
    void criaPECCodigoNulo() {
        assertThrows(NullPointerException.class, () -> new PEC(null, "112345678-6",
                2016, "Ementa PEC", "saude", "http://example.com/semana_saude", "153"));
    }

    @Test
    void criaPECDniVazio() {
        assertThrows(IllegalArgumentException.class, () -> new PEC("PEC 1/2016", "",
                2016, "Ementa PEC", "saude", "http://example.com/semana_saude", "153"));
    }

    @Test
    void criaPECDniNulo() {
        assertThrows(NullPointerException.class, () -> new PEC("PEC 1/2016", null,
                2016, "Ementa PEC", "saude", "http://example.com/semana_saude", "153"));
    }
    ...
    void criaPECEmentaNula() {
        assertThrows(NullPointerException.class, () -> new PEC("PEC 1/2016",
